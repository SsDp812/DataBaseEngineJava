...
import com.digdes.school.Table.Interfaces.DataBaseInterface;
import com.digdes.school.Table.Utils.Filter;
import com.digdes.school.Table.Utils.Pair;
import com.digdes.school.Table.Utils.RequestNormalizer;
import com.digdes.school.Table.Utils.RowCheckerForContaining;

import java.util.*;

import static com.digdes.school.Table.Utils.Filter.deleteQuotes;
import static com.digdes.school.Table.Utils.Filter.filter;

public class TableCollection implements DataBaseInterface {
    ...
    public TableCollection() throws Exception {
        columnsTypes = new HashMap<>();
        table = new ArrayList<>();
        generateTable();
    }
    public TableCollection(List<Map<String,Object>> table,Map<String,String> columnsTypes){
        this.table = table;
        this.columnsTypes = columnsTypes;
    }

    public TableCollection(Map<String,String> columnsTypes){
        this.columnsTypes = columnsTypes;
        table = new ArrayList<>();
    }
